...
setuptools.setup(
    ...
    author="Bart Kleijngeld",
    author_email="bartkl@gmail.com",
    description="A really useful Robot Framework library for working with Excel 2010 (and above) files and Python 3.",
    url="https://github.com/e-peters-waternet/robotframework-excellentlibrary",
    packages=setuptools.find_packages(),
    classifiers=(
